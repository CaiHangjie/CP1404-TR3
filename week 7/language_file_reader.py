...
def main():
    ...
    for line in in_file:
        ...
        """Correctly read the Pointer Arithmetic field and pass it as a Boolean value"""
        language = ProgrammingLanguage(parts[0], parts[1], reflection, int(parts[3]), parts[4] == "True")
